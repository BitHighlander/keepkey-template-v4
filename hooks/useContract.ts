...
import { RPC_PROVIDERS } from '../utilities/constants/providers'
import { WRAPPED_NATIVE_CURRENCY } from '../utilities/constants/tokens'
import { useEffect, useMemo } from 'react'
// import ARGENT_WALLET_DETECTOR_ABI from 'uniswap/src/abis/argent-wallet-detector.json'
import EIP_2612 from '../utilities/abis/eip_2612.json'
import ENS_PUBLIC_RESOLVER_ABI from '../utilities/abis/ens-public-resolver.json'
import ENS_ABI from '../utilities/abis/ens-registrar.json'
import ERC1155_ABI from '../utilities/abis/erc1155.json'
import ERC20_ABI from '../utilities/abis/erc20.json'
import ERC721_ABI from '../utilities/abis/erc721.json'
import {
  ...
  Erc721,
  Weth,
} from '../utilities/abis/types'
import { NonfungiblePositionManager, UniswapInterfaceMulticall } from '../utilities/abis/types/v3'
import { V3Migrator } from '../utilities/abis/types/v3/V3Migrator'
import WETH_ABI from '../utilities/abis/weth.json'
import { getContract } from '../utilities/contracts/getContract'
